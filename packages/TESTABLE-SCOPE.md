...
_Latest: iOS 97.0% of testable-logic scope, Android 93.0% merged. Both suites green; remaining gaps are the gesture/streaming/nav ceiling documented above._
...
- **Android merged: 93.0%** (was 60.7%; UI countable via JaCoCo merge). Cracked
