...
_Latest: iOS 96.7% of testable-logic scope, Android 88.4% merged. Both suites green; remaining gaps are the gesture/streaming/nav ceiling documented above._
...
- **Android merged: 88.4%** (was 60.7%; UI countable via JaCoCo merge). Cracked
