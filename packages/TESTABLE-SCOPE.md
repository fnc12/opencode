...
_Latest: iOS 97.0% of testable-logic scope, Android 92.7% merged. Both suites green; remaining gaps are the gesture/streaming/nav ceiling documented above._
...
- **Android merged: 92.7%** (was 60.7%; UI countable via JaCoCo merge). Cracked
