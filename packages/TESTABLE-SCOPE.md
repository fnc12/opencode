...
_Latest: iOS 96.7% of testable-logic scope, Android 83.6% merged. Both suites green; remaining gaps are the gesture/streaming/nav ceiling documented above._
...
- **Android merged: 83.6%** (was 60.7%; UI countable via JaCoCo merge). Cracked
